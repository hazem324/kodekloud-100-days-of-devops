...
* **Iron Gallery (Frontend)** → Stateless
* **Iron DB (MariaDB)** → Stateful
...
⚠️ In production, never store passwords directly in YAML.
...
You are essentially practicing real-world DevOps architecture patterns here 🚀
