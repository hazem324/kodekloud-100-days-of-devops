Below is the **final `README.md` content**, ready to copy-paste **as-is** into a file named **`README.md`**.
...
* [x] Zip utility installed
* [x] Script located under `/scripts`
* [x] Script executable
* [x] SSH key-based authentication configured
* [x] Backup archive created
* [x] Backup archive transferred remotely
...
- Make it **100% KodeKloud answer format**
- Add a **diagram explanation**
- Convert it into a **Day X lab solution**
- Add **error handling + logging version**
