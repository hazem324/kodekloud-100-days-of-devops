...
You want the **README to show only example commands**, **without real server IPs or usernames** (generic placeholders), while keeping it professional and reusable.

Here is the **corrected README.md** version.
...
Incorrect permissions can prevent SSH login.
